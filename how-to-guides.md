...
3. **Remove the Plastic Cover**
    ...
    If your car has a **plastic cover** underneath that is **covering the engine**, you will need to remove this first. (Some cars have a seperate hatch on the plastic cover to easily reach the oil filter and drain plug, in this case you don't need to remove the plastic engine cover.)
